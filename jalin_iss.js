...
const DIR_PATHNAME = "download/iss/";
const DIR_SOURCENAME = "upload/iss/";

// Define Variabel
// ==========================================================================================

const uploaded_name = `QR_SETTLE_360004_000898_${TODAY_DATE}_ISS`; // Nama file yang akan dibaca, bisa di replace!

const download = {
  normal: `${DIR_PATHNAME}iss_${TODAY_DATE}.xlsx`, // Nama file yang akan terdownload untuk transaksi normal
  dispute: `${DIR_PATHNAME}dispute_iss_${TODAY_DATE}.xlsx`, // Nama file yang akan terdonwload untuk transaksi dispute
};
